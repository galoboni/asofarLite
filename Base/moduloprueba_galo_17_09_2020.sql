...
MySQL - 5.5.5-10.4.14-MariaDB : Database - asofar_moduloprueba
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`asofar_moduloprueba` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `asofar_moduloprueba`;
...
insert  into `cabecera_venta`(`id`,`num_venta`,`fecha_creacion`,`id_cliente`,`id_usuario`,`id_sucursal`,`tipo_pago`,`tipo_venta`,`subtotal_con_iva`,`subtotal_sin_iva`,`iva_total`,`descuento_total`,`total`,`utilidad`,`estado`) values (1,'000001','2019-03-21 17:43:07',10,36,2,'contado','Factura',10.8000000,35.1000000,1.2960000,0.0000000,51.4080000,13.3392000,'A'),(2,'000002','2019-03-21 17:50:24',3,36,2,'contado','Factura',10.8000000,35.1000000,1.2960000,0.0000000,51.4080000,13.3392000,'A'),(3,'000003','2019-03-22 17:37:44',10,36,2,'contado','Factura',0.0000000,3.6000000,0.0000000,0.0000000,4.0320000,0.6720000,'A'),(4,'000004','2019-03-29 19:01:56',10,36,2,'contado','Factura',90.0000000,0.0000000,10.8000000,0.0000000,100.8000000,16.8000000,'A');
...
/*Data for the table `caja_app` */

LOCK TABLES `caja_app` WRITE;

insert  into `caja_app`(`id_caja_app`,`nombre_caja_app`,`fecha_registro_app`) values (1001,'40:a1:08:04:79:50','2020-09-07 15:20:07');
...
insert  into `categoria`(`id_categoria`,`nombre`,`estado`,`usuario_creacion`,`fecha_creacion`,`usuario_actualizacion`,`fecha_actualizacion`) values (1,'ALIMENTO','I',NULL,'2019-11-01 14:01:22',NULL,'2019-11-01 14:13:11'),(2,'BEBIDAS','A',NULL,'2019-11-01 14:01:52',NULL,'2019-11-01 14:13:34'),(3,'MEDICINAS','A',NULL,'2019-11-01 14:02:24',NULL,'2019-11-01 14:02:24'),(4,'UTENSILIOS PARA BEBES ','A','ADMIN','2020-02-08 22:35:55',NULL,NULL),(5,'COSMETICOS','A','ADMIN','2020-02-11 16:02:13',NULL,NULL),(6,'BOTELLONES','A',NULL,NULL,NULL,NULL),(7,'HOGAR','A',NULL,NULL,NULL,NULL),(8,'PRUEBA','A',NULL,NULL,NULL,NULL),(9,'CESAR PRUEBA','A',NULL,NULL,NULL,NULL),(10,'PRUEBA2CESAR','A',NULL,NULL,NULL,NULL);
...
/*Data for the table `codigobarra_app` */

LOCK TABLES `codigobarra_app` WRITE;

insert  into `codigobarra_app`(`id_codigobarras_app`,`codigobarra_app`,`nombre_codigo_app`,`id_caja_resgistra_codigobarra`,`fecha_registrocodigo_app`) values (1,'7909189114641','DESODORANTE SPRAY 150ml/104g',1,'2020-09-01 13:08:35');
...
insert  into `detalle_faltantes`(`id_detalle_faltantes`,`id_producto`,`id_usuario`,`fecha_registro`,`cantidad`,`estado`) values (2,21,NULL,'2019-03-22 16:12:33',112,'TR'),(3,22,NULL,'2019-03-21 16:52:41',207,'OK'),(4,23,NULL,'2019-03-21 18:07:56',320,'TR'),(5,25,NULL,'2018-12-13 16:29:18',500,'OK'),(6,24,NULL,'2020-09-15 22:26:31',401,'TR'),(10,27,NULL,'2020-09-15 22:32:57',595,'TR'),(11,32,NULL,'2019-03-21 16:52:41',60,'TR'),(12,31,2,'2019-03-19 17:47:07',100,'TR'),(13,33,2,'2020-09-15 22:27:14',56,'TR'),(14,34,NULL,'2019-02-25 00:00:00',13,'NO'),(15,35,NULL,'2019-02-25 00:00:00',0,'NO'),(16,36,NULL,'2019-03-21 00:00:00',0,'NO'),(17,37,NULL,'2019-03-22 16:13:06',34,'TR'),(18,38,NULL,'2019-03-22 17:23:34',0,'OK'),(19,39,NULL,'2019-03-29 00:00:00',0,'NO'),(20,40,NULL,'2019-03-29 00:00:00',0,'NO'),(21,41,NULL,'2019-03-29 18:56:33',5,'OK'),(22,42,NULL,'2019-04-11 00:00:00',0,'NO'),(23,43,NULL,'2019-04-15 00:00:00',0,'NO'),(24,46,NULL,'2020-09-14 00:00:00',0,'NO'),(25,48,NULL,'2020-09-14 00:00:00',0,'NO'),(26,49,NULL,'2020-09-14 00:00:00',0,'NO'),(27,50,NULL,'2020-09-14 00:00:00',0,'NO'),(28,51,NULL,'2020-09-14 00:00:00',0,'NO'),(29,52,NULL,'2020-09-14 00:00:00',0,'NO'),(30,53,NULL,'2020-09-14 00:00:00',0,'NO'),(31,54,NULL,'2020-09-14 00:00:00',0,'NO'),(32,55,NULL,'2020-09-14 00:00:00',0,'NO'),(33,56,NULL,'2020-09-14 00:00:00',0,'NO'),(34,57,NULL,'2020-09-17 00:00:00',0,'NO');
...
insert  into `envase`(`id_envase`,`nombre`,`estado`) values (1,'FRA','A'),(2,'CAJAS','A'),(3,'funda','A'),(4,'unidades','A'),(5,'gg','A'),(6,'COSTAL','A'),(7,'PRUEBA','A');
...
insert  into `iva`(`id_iva`,`iva`,`fecha`,`id_usuario`,`est`) values (13,0.12,'2019-01-31',1,'A'),(17,0.14,'2019-01-31',1,'A'),(18,0.16,'2019-01-31',1,'A');
...
insert  into `marcas`(`id_marcas`,`nombre`,`estado`) values (1,'BAYER','A'),(2,'PELIKAN','A'),(3,'BAGO','A'),(4,'AVON','A'),(5,'MARCACION','I'),(6,'MARCAMARCA','I'),(7,'VIRDI','A'),(8,'PRUEBA','I'),(9,'LENOVO\r\n','A'),(10,'LENOVO','A');
...
insert  into `medidas`(`id_medidas`,`nombre_medida`,`estado`) values (1,'ML','A'),(2,'LT','A'),(3,'MML','A'),(4,'15 LT','A'),(5,'56 GR','A'),(6,'GR','A'),(7,'PRUEBA1','A'),(8,'PRUEBA2','A'),(9,'PRUEBA3','A'),(10,'PRUEBA4','A'),(11,'PRUEBA5','A'),(12,'100 LT','A'),(13,'6-10 KG','A'),(14,'150ML','A'),(15,'15ML/16G','A'),(16,'PULGADAS','A');
...
insert  into `precios`(`id_precio`,`id_producto`,`precio_base`,`precio_compra`,`precio_venta`,`estado`,`fecha_registro`,`id_usuario`,`porcentaje`,`descuentoVenta`) values (1,22,NULL,0.55,0.60,'I','0000-00-00 00:00:00',NULL,0,0),(2,22,NULL,0.70,0.80,'I','0000-00-00 00:00:00',NULL,0,0),(8,22,NULL,0.63,0.90,'A','2018-12-20 17:56:59',2,0,0),(13,22,NULL,0.65,0.95,'A','2018-12-20 19:24:12',2,0,0),(14,22,NULL,0.45,0.35,'I','2018-12-20 19:24:12',5,0,0),(16,22,NULL,0.59,0.97,'I','2018-12-14 00:57:18',2,0,0),(17,22,NULL,0.73,0.96,'I','2018-12-14 08:28:31',2,0,0),(18,30,NULL,15.60,32.62,'A','2018-12-18 03:27:01',2,0,0),(19,22,NULL,0.44,0.61,'I','2020-09-22 03:21:35',NULL,0,0),(20,28,NULL,0.63,1.24,'A','2019-01-03 02:12:54',2,0,0),(21,28,NULL,0.89,0.92,'I','2018-12-19 00:01:25',2,0,0),(22,28,NULL,0.96,0.97,'I','2018-12-20 00:49:40',2,0,0),(23,27,NULL,1.56,1.57,'I','2019-01-03 17:10:12',2,0,0),(24,27,NULL,1.42,1.78,'A','2019-01-03 17:10:29',2,0,0),(25,27,NULL,1.62,1.96,'A','2019-01-03 17:10:41',2,0,0),(26,23,NULL,1.92,1.95,'A','2018-12-20 01:25:44',2,0,0),(27,31,NULL,0.65,0.90,'A','2019-01-16 03:53:26',2,0,0),(28,31,NULL,0.90,0.96,'I','2020-09-22 03:21:35',NULL,0,0),(29,31,NULL,0.63,0.79,'I','2019-01-03 17:11:01',2,0,0),(30,28,NULL,0.86,0.98,'I','2020-09-22 03:21:35',NULL,0,0),(31,24,NULL,0.26,0.30,'I','2018-12-21 01:03:22',2,0,0),(32,24,NULL,0.60,0.61,'I','2020-09-22 03:21:35',NULL,0,0),(33,24,NULL,0.56,0.57,'I','2018-12-21 01:15:00',2,0,0),(34,24,NULL,58.60,59.60,'I','2020-09-22 03:21:35',NULL,0,0),(35,24,NULL,0.67,0.97,'A','2020-09-22 03:21:35',NULL,0,0),(36,28,NULL,0.90,0.96,'I','2018-12-21 01:39:54',2,0,0),(37,31,NULL,0.67,0.65,'I','2018-12-21 11:55:28',2,0,0),(38,31,NULL,0.68,0.69,'I','2019-01-02 15:23:05',2,0,0),(39,32,NULL,2.79,2.87,'A','2018-12-21 11:10:45',2,0,0),(40,27,NULL,2.34,2.88,'A','2019-01-20 00:00:01',2,0,0),(41,27,NULL,23.50,24.67,'A','2019-01-20 00:00:00',2,0,0),(42,21,NULL,4.56,6.76,'A','2019-01-20 00:00:00',2,0,0),(43,30,NULL,4.67,6.89,'A','2019-01-20 03:46:15',2,0,0),(44,33,NULL,0.75,1.00,'A','2019-01-20 12:38:15',2,0,0),(45,34,NULL,12.50,12.75,'A','2019-02-25 16:39:24',2,0,0),(46,35,NULL,8.90,9.00,'A','2019-02-25 16:58:10',2,0,0),(47,36,NULL,0.80,1.20,'A','2019-03-21 16:37:36',2,0,0),(48,36,NULL,0.90,1.30,'A','2019-03-21 16:44:39',2,0,0),(49,37,NULL,1.00,1.30,'A','2019-03-21 18:05:26',2,0,0),(50,25,NULL,23.40,26.21,'A','2019-03-22 14:10:06',2,0,0),(51,38,NULL,0.25,0.30,'A','2019-03-22 17:09:14',2,0,0),(52,38,NULL,0.20,0.24,'A','2019-03-22 17:16:35',2,0,0),(53,37,NULL,1.50,1.73,'A','2019-03-23 23:03:02',2,15,0),(54,39,NULL,23.45,26.26,'A','2019-03-29 18:09:31',2,12,0),(55,40,NULL,0.63,0.03,'A','2019-03-29 18:10:37',3,0,0),(56,41,NULL,5.00,6.00,'A','2019-03-29 18:55:06',2,20,0),(57,41,NULL,6.00,6.60,'A','2019-03-29 18:57:20',2,10,0),(58,42,34.00,34.56,35.00,'A','2019-04-11 10:04:53',2,0,10),(59,27,67.00,80.00,80.00,'A','2019-04-12 17:20:44',2,0,7),(60,27,16.00,10.00,10.00,'A','2019-04-12 17:22:30',2,0,0),(61,27,0.00,2.34,2.88,'A','2019-04-12 17:23:54',2,0,0),(62,23,0.00,1.92,1.96,'A','2019-04-12 17:30:42',2,0,0),(63,23,0.00,1.92,1.99,'A','2019-04-12 17:31:13',2,0,0),(64,44,10.00,10.00,14.00,'A','2020-09-15 22:28:42',2,40,2),(65,21,10.00,11.00,12.00,'A','2020-09-17 16:44:10',2,0,5),(66,58,1.00,1.00,1.50,'A','2020-09-22 03:21:35',2,NULL,0);
...
insert  into `presentaciones`(`idPresentaciones`,`nombre`,`estado`,`usuarioCreacion`,`fechaCreacion`) values (1,'FRASCO','A','ADMIN','2019-11-01 13:21:53'),(2,'TUBO','A',NULL,NULL),(3,'CAJA','A',NULL,NULL);
...
CREATE TABLE `productos` (
  ...
  `codigo_barras` bigint(30) DEFAULT NULL,
...
insert  into `productos`(`id_productos`,`nombre`,`descripcion`,`fecha_registro`,`peso`,`id_tipo`,`id_medidas`,`id_categoria`,`id_marcas`,`estado`,`id_usuario`,`iva`,`cantidad_minima`,`receta`,`unidades`,`codigo_barras`,`id_presentacion`) values (21,'ASPIRINA','DOLORES ','2018-11-16 00:00:00',14.00,5,14,2,7,'A',1,'NO',10,'CON RECETA',0,NULL,3),(22,'AMOXICILINA','INFECCION','2020-09-21 07:54:08',10.20,5,5,2,2,'A',2,'NO',24,NULL,NULL,NULL,1),(23,'PASTA','MEBOCAINA','2020-09-21 07:54:08',1.26,6,1,1,1,'A',3,'SI',14,NULL,NULL,NULL,2),(24,'IBUPROFENO ','DOLORES DE CABEZA,ESTOMAGO,FIEBRE','2020-09-21 07:54:09',0.50,11,5,2,1,'A',7,'NO',7,NULL,NULL,NULL,3),(25,'LEMONFLU2','RESFRIADOS ','2020-09-21 07:54:09',10.00,7,5,2,1,'A',2,'NO',29,NULL,NULL,NULL,1),(27,'tucol','jarabe para la toz','2020-09-21 07:54:09',15.60,2,3,1,1,'A',3,'NO',14,NULL,NULL,NULL,3),(28,'GAMALATE','CONCENTRACION','2020-09-21 07:54:09',2.60,7,1,2,1,'A',2,'0.12',15,NULL,NULL,NULL,1),(29,'ZALEPLA','RELAJACION','2020-09-21 07:54:10',2.60,11,1,1,1,'A',3,'NO',14,NULL,NULL,NULL,2),(30,'AFRIN','PARA DESCONGESTIONAR LA NARIZ','2020-09-21 07:54:10',2.36,7,3,1,1,'A',5,'NO',19,NULL,NULL,NULL,3),(31,'VITAMINA C','VITAMINAS','2020-09-21 07:54:10',0.63,5,2,3,1,'A',2,'0.12',15,NULL,NULL,NULL,1),(32,'OMEPRASOL','INFECCIONES','2020-09-21 07:54:11',2.30,5,6,2,2,'A',2,'0.12',45,NULL,NULL,NULL,2),(33,'TRIPLE ACCION','PASTA DENTAL','2020-09-21 07:54:11',1.05,10,4,2,1,'A',2,'0.12',10,NULL,NULL,NULL,3),(34,'ALCOHOL','LIMPIEZA CORPORAL','2020-09-21 07:54:12',12.00,7,3,2,1,'A',2,'',23,NULL,NULL,NULL,3),(35,'TERMOMETRO','FIEBRE','2020-09-21 07:54:12',0.23,5,4,1,1,'A',2,'0.12',34,NULL,NULL,NULL,2),(36,'PARACETAMOL2','PRUEBA2','2020-09-21 07:54:12',34.00,6,5,2,3,'A',36,'NO',35,NULL,NULL,NULL,2),(37,'PASTA','DENTAL','2020-09-21 07:54:12',0.80,10,6,2,2,'A',53,'0.12',15,NULL,NULL,NULL,3),(38,'APRONAX','NAPROXENO SODICO 500MG','2020-09-21 07:54:13',550.00,6,6,2,1,'I',53,'NO',1,NULL,NULL,NULL,1),(39,'SDCWD','SDCSD','2020-09-21 07:54:13',10.00,5,6,2,3,'A',53,'NO',23,'SIN RECETA ',NULL,NULL,2),(40,'AMOXICILINA1','INFECCION1','2020-09-21 07:54:13',10.20,5,5,4,2,'A',3,'NO',24,NULL,NULL,NULL,3),(41,'LACTIBON LOCION 3.5 PH','SUSTITUTO DE JABON','2020-09-21 07:54:14',8.00,7,1,1,1,'A',53,'0.12',3,'SIN RECETA ',NULL,NULL,2),(42,'ACERLET','ACERLET 500','2020-09-21 07:54:14',3.00,7,6,2,3,'A',53,'NO',23,'SIN RECETA ',24,NULL,2),(43,'PAÑALIN','EXTRA GRANDES','2020-09-21 07:54:14',10.00,12,13,2,2,'A',53,'NO',3,'SIN RECETA ',24,7702111376564,1),(44,'COLA BLANCA ','GOMA','2020-09-09 00:00:00',15.00,16,15,7,4,'A',1001,'12',1,'NO APLICA',1,2000013895288,2),(45,'Foco','foco','2020-09-12 00:00:00',12.00,2,1,1,1,'A',1001,'12',12,'SIN RECETA ',2,7702048293620,1),(46,'JARABE','WWWWWWWWWWWWWWWW','2020-09-14 00:00:00',10.00,14,14,NULL,3,'A',43,'NO',20,'CON RECETA',0,1111111111111,1),(48,'CLOROXON','LIQUIDO BLANCO','2020-09-14 00:00:00',2.00,14,2,NULL,4,'A',43,'NO',30,'SIN RECETA ',0,5555555555555,3),(49,'CREMA','VERDE','2020-09-14 00:00:00',20.00,14,6,NULL,7,'A',43,'NO',20,'SIN RECETA ',1,3433546465656,2),(50,'PRIMAX','CONTIENE TABLETAS ','2020-09-14 00:00:00',2.00,14,14,NULL,4,'A',43,'NO',30,'SIN RECETA ',12,4335354354353,3),(51,'UNGUENTO','CREMA','2020-09-14 00:00:00',15.00,14,6,NULL,3,'A',43,'NO',20,'SIN RECETA ',1,3553454353453,1),(52,'CREMA BLANQUEADORA','TTTTTTTTTTTTTTT','2020-09-14 00:00:00',20.00,14,6,NULL,3,'A',43,'NO',34,'SIN RECETA ',12,9776090908786,3),(53,'CCCCCCCCCCCCCCCCC','CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC','2020-09-14 00:00:00',12.00,6,4,NULL,1,'A',43,'0.12',12,'SIN RECETA ',12,0,1),(54,'DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD','DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD','2020-09-14 00:00:00',12.00,5,12,5,2,'I',43,'0.12',12,'CON RECETA',12,0,1),(55,'CESAR','CESAR','2020-09-14 00:00:00',12.00,7,4,4,3,'A',43,'0.12',12,'CON RECETA',12,0,1),(56,'ABC1234','ABC1234','2020-09-14 00:00:00',1.00,6,4,2,7,'A',43,'SI',12,'SIN RECETA ',1,0,1),(57,'CAPSULAS ','CAPSULAS ALER','2020-09-17 23:20:56',2.00,8,5,3,1,'A',43,'NO',15,'SIN RECETA ',1,594681634,3),(58,'PRUEBA97','PRUEBA97X1','0000-00-00 00:00:00',10.00,6,7,5,3,'A',1001,'NO',1,'SIN RECETA',10,123,2);
...
CREATE TABLE `productos_app` (
  ...
  `precio_producto_app` bigint(30) DEFAULT NULL,
  `id_presentacion` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id_productos`),
  UNIQUE KEY `codigo_barras_UNIQUE` (`codigo_barras`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

/*Data for the table `productos_app` */

LOCK TABLES `productos_app` WRITE;

insert  into `productos_app`(`id_productos`,`nombre`,`descripcion`,`fecha_registro`,`peso`,`id_tipo`,`id_medidas`,`id_categoria`,`id_marcas`,`estado`,`id_usuario`,`iva`,`cantidad_minima`,`receta`,`unidades`,`codigo_barras`,`registro_actualizado`,`precio_producto_app`,`id_presentacion`) values (3,'BLACK SUEDE','SPRITE BLACK SUEDE','2020-09-09 23:26:32',12.00,2,1,5,1,'A',1001,'12',1,'NO APLICA',1,'7909189114641','S',12,1),(4,'COLA BLANCA ','GOMA','2020-09-09 23:53:45',15.00,16,15,7,4,'A',1001,'12',1,'NO APLICA',1,'2000013895288','S',15,2),(5,'Foco','foco','2020-09-12 17:26:01',12.00,2,1,1,1,'A',1001,'12',12,'NO APLICA',2,'7702048293620','S',28,1);
...
insert  into `stock`(`id_stock`,`cantidad`,`id_precio`) values (1,0,42),(2,0,20),(3,20,8),(4,77,44),(5,12,13),(7,0,26),(8,0,35),(9,0,39),(10,33,27),(13,0,40),(14,0,25),(15,-5,52),(16,24,55),(17,5,56);
...
insert  into `tipo`(`id_tipo`,`nombre`,`estado`) values (2,'JARABE PARA LA TOZ','A'),(4,'PASTILLA PARA DOLORES DE CABEZ','A'),(5,'ANTIBIÓTICO','A'),(6,'ANALGESICO','A'),(7,'ANTIALÉRGICOS','A'),(8,'ANTIINFLAMATORIOS ','A'),(9,'PELOTAS','A'),(10,'VIVERES','A'),(11,'ANTIPIRÉTICOS','A'),(12,'ANTIIRRITACIONES','A'),(13,'VARIOS','A'),(14,'MEDICINA','A'),(16,'LIQUIDO','A'),(17,'AS','A'),(18,'PRUEBA','I'),(19,'XXX','A');
...
/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `EncontrarID`(nombre1 VARCHAR(80),id_marcas1 BIGINT(20),id_medidas1 BIGINT(20),id_tipo1 BIGINT(20)) RETURNS int(11)
BEGIN
	DECLARE valor INT; 
...
/* Function  structure for function  `id_nombre_categoria` */

/*!50003 DROP FUNCTION IF EXISTS `id_nombre_categoria` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `id_nombre_categoria`(nombre_categoria VARCHAR(60)) RETURNS int(11)
BEGIN
	DECLARE valor INT;
	SET valor= (SELECT id_categoria FROM categoria WHERE nombre = nombre_categoria);
	RETURN valor;
    END */$$
DELIMITER ;

/* Function  structure for function  `id_nombre_marca` */

/*!50003 DROP FUNCTION IF EXISTS `id_nombre_marca` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `id_nombre_marca`(nombre_marca VARCHAR(50)) RETURNS int(11)
BEGIN
	DECLARE valor INT;
	SET valor = (SELECT id_marcas FROM marcas WHERE nombre = nombre_marca);
	RETURN valor;

    END */$$
DELIMITER ;

/* Function  structure for function  `id_nombre_medida` */

/*!50003 DROP FUNCTION IF EXISTS `id_nombre_medida` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `id_nombre_medida`(nombre_medida1 VARCHAR(80)) RETURNS int(11)
BEGIN
	DECLARE valor INT;
	SET valor = (SELECT id_medidas FROM medidas WHERE nombre_medida = nombre_medida1);
	RETURN valor;
    END */$$
DELIMITER ;

/* Function  structure for function  `id_nombre_presentacion` */

/*!50003 DROP FUNCTION IF EXISTS `id_nombre_presentacion` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `id_nombre_presentacion`(nombre_presentacion VARCHAR(50)) RETURNS int(11)
BEGIN
	DECLARE valor INT;
	SET valor = (SELECT idPresentaciones FROM presentaciones WHERE nombre = nombre_presentacion);
	RETURN valor;
    END */$$
DELIMITER ;

/* Function  structure for function  `id_nombre_tipo` */

/*!50003 DROP FUNCTION IF EXISTS `id_nombre_tipo` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `id_nombre_tipo`(nombre_tipo varchar(80)) RETURNS int(11)
BEGIN
	declare valor int;
	set valor = (select id_tipo from tipo where nombre = nombre_tipo);
	return valor;
    END */$$
DELIMITER ;
...
/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `validacion`(ruc1 TEXT) RETURNS int(11)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `validarCategoriaProducto`(nombre1 VARCHAR(80)) RETURNS int(11)
BEGIN
	DECLARE valor INT; 
...
/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `validarEnvaseProducto`(nombre1 VARCHAR(80)) RETURNS int(11)
BEGIN
	DECLARE valor INT; 
...
/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `validarMarcaProducto`(nombre1 VARCHAR(80)) RETURNS int(11)
BEGIN
	DECLARE valor INT; 
...
/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `validarMedidaProducto`(nombre_medida1 VARCHAR(80)) RETURNS int(11)
BEGIN
	DECLARE valor INT; 
...
/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `validarPresentacionesProducto`(nombre1 varchar(80)) RETURNS int(11)
BEGIN
	declare valor int; 
    SELECT COUNT(idPresentaciones)INTO valor FROM presentaciones
	WHERE nombre = nombre1 and estado = 'A';
...
/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `validarProveedor`(cedula VARCHAR(15)) RETURNS int(11)
BEGIN
	DECLARE val INT;
...
/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `validarPrueba`(nombre1 TEXT, apellido1 TEXT,direccion1 TEXT ) RETURNS bigint(20)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` FUNCTION `validarTipoProducto`(nombre1 VARCHAR(80)) RETURNS int(11)
BEGIN
	DECLARE valor INT; 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ActivarEstadoNotaPedido`(IN id_cabecera_nota_pedidos1 BIGINT,
OUT valor TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `actualizar`(IN id_Laboratorio1 BIGINT, IN RUC1 TEXT, IN nombre1 TEXT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ActualizarCabeceraNotaPedido`(IN plazo1 TEXT, IN formapago2 TEXT, IN iva3 DECIMAL(10,7),
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `actualizarCliente`(
IN cedula123 TEXT,
IN nombre TEXT,
IN apellido TEXT,
IN direccion TEXT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ActualizarDetalleCompras`(IN id_detalle_nota_pedidos1 BIGINT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ActualizarDetalleIndividualNotaPedido`(IN id_detalle_nota_pedidos1 BIGINT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ActualizarDetalleNotaPedido`(IN id_detalle_nota_pedidos1 BIGINT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `actualizarPrecioCompra`(IN id_producto1 BIGINT,IN precioBase2 DOUBLE(5,2),IN precio_compra2 DOUBLE(5,2),IN precio_venta3 DOUBLE(5,2),IN fecha4 DATETIME,IN id_usu BIGINT,IN Porcen BIGINT,IN descvent BIGINT,OUT valor1 TEXT )
BEGIN
	DECLARE id_pre INT;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `actualizarPrecioConvertidor`(IN id_producto1 BIGINT,IN precio_compra2 DOUBLE(5,2),IN precio_venta3 DOUBLE(5,2),IN fecha4 DATETIME,IN id_usu BIGINT,IN Porcen BIGINT,OUT valor2 TEXT )
BEGIN
	DECLARE id_pre INT;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `actualizarPrecioProducto`(IN consu TEXT,OUT valor TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ActualizarStockVentas`(
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Actualizar_Categoria`(IN nombre_f TEXT,IN id_tipo_f INT, OUT salida TEXT)
BEGIN
DECLARE nra INT;
SET nra = (SELECT validarCategoriaProducto(nombre_f));
	IF(nra<1) THEN 
    -- cambio echo por cecj
	UPDATE categoria SET nombre = nombre_f WHERE id_categoria = id_tipo_f;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Actualizar_Envase`(IN nombre_f TEXT,IN id_tipo_f INT, OUT salida TEXT)
BEGIN
DECLARE nra INT;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `actualizar_punto_venta`(id1 BIGINT, nombre_localidad1 TEXT,nombre_local1 TEXT,  direccion1 TEXT,dir_ip1 TEXT,  IN observacion TEXT, OUT salida TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Actualizar_Tipo`(IN nombre_f TEXT,IN id_tipo_f INT, OUT salida TEXT)
BEGIN
DECLARE nra INT;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `bitacora_seguridad`(IN `user1` TEXT, IN `password1` TEXT, IN `ip_equipo1` TEXT, /*in `ip_publico1` text,*/
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `buscarIDCabeceraCompras`(IN descuento1 DECIMAL(10,7),
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `buscarIDDetalleCompras`(IN idcab BIGINT,IN descuento1 DECIMAL(10,7),
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `BuscarIDProductoNuevo`(
...
`id_medidas`=id_medidas1 AND `id_presentacion`=id_envase1 AND `id_categoria`=id_categoria1 AND `id_marcas`=id_marcas1 AND`estado`='A' AND `id_usuario`=id_usuario1 AND`iva`=iva1 AND `cantidad_minima`=cantidad_minima1 AND `receta`= receta1 AND `unidades`=unidade1); 
    END */$$
DELIMITER ;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `BuscarStockVentas`(
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `cambiarEstadoDevolucion`(IN id_nota BIGINT, IN id_compra BIGINT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `cantidad_compras`(IN fecha1 DATE, IN fecha2 DATE)
BEGIN
SELECT DISTINCT
pr.id_producto,
p.nombre,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `cantidad_ventas`(IN fecha1 DATE, IN fecha2 DATE)
BEGIN
SELECT DISTINCT
p.id_productos,
p.nombre,
...
/* Procedure structure for procedure `Categoria_Producto` */

/*!50003 DROP PROCEDURE IF EXISTS  `Categoria_Producto` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Categoria_Producto`()
BEGIN
SELECT id_categoria, nombre FROM  categoria WHERE estado = 'A' ORDER BY id_categoria;
END */$$
DELIMITER ;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `convertirStock`(IN Stock1 BIGINT,IN Stock2 BIGINT,IN valor1 BIGINT,valor2 BIGINT,OUT valor TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `convertirStockProductoNuevo`(IN Stock1 BIGINT,IN id_precio2 BIGINT,IN valor1 BIGINT,valor2 BIGINT,OUT valor TEXT)
BEGIN
	DECLARE id_preciox BIGINT;
	DECLARE cantidadx BIGINT;
	DECLARE cant BIGINT;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `DesactivarNotaPedido`(IN id_cabecera_nota_pedidos1 BIGINT,
OUT valor TEXT)
BEGIN
	UPDATE cabecera_nota_pedidos 
	SET estado = 'NO'
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `devolverProductosComprados`(IN cantidad1 INT,IN id_precio2 BIGINT,OUT valor TEXT)
BEGIN
    	DECLARE id_preciox BIGINT;
	DECLARE cantidadx BIGINT;
	DECLARE cant BIGINT;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `edicionCabeceraNota`(IN iva8 DECIMAL(10,7),
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `edicionCompra`(IN iva8 DECIMAL(10,7),
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `editarMarcaProducto`(IN nombre_medida1 VARCHAR(80),IN pos INT, OUT valor1 TEXT)
BEGIN
	DECLARE nr INT;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `editarMedidaProducto`(IN nombre_medida1 VARCHAR(80),IN pos INT, OUT valor1 TEXT)
BEGIN
	DECLARE nr INT;
	IF (nombre_medida1='') THEN
	SET valor1 ='campos invalidos';
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `editarProveedor`(IN id_proveedor_clase1 BIGINT, IN entidad3 VARCHAR(100),
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `eliminar`(id_Laboratorio1 BIGINT, OUT valor  TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `eliminarDetalleCompra`(IN id_cab BIGINT,IN id_det BIGINT,OUT valor TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `EliminarDetalleDevolucion`(IN detNotaPed BIGINT,IN idPrecio1 BIGINT, IN cantidad1 BIGINT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `EliminarDetalleNotaPedido`(IN id_detalle_nota_pedidos1 BIGINT,OUT valor TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `eliminarMarcaProducto`(IN pos INT, OUT valor1 TEXT)
BEGIN
	-- DECLARE nr INT;
	-- IF (nombre_medida1='') THEN
	-- SET valor1 ='campos invalidos';
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `eliminarMedidaProducto`(IN pos INT, OUT valor1 TEXT)
BEGIN
	-- DECLARE nr INT;
	-- IF (nombre_medida1='') THEN
	-- SET valor1 ='campos invalidos';
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `eliminarProducto`(IN id_productos1 BIGINT,OUT valor TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `eliminarProveedor`(IN op BIGINT, id_proveedor1 BIGINT,OUT valor TEXT)
BEGIN
	IF (op=1)THEN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Eliminar_Categoria`(IN id_tipo_f INT, OUT salida TEXT)
BEGIN
DECLARE esta_f CHAR(1);
    SET esta_f = 'I';
UPDATE categoria SET estado = esta_f WHERE id_categoria = id_tipo_f;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Eliminar_Envase`(IN id_tipo_f INT, OUT salida TEXT)
BEGIN
DECLARE esta_f CHAR(1);
    SET esta_f = 'I';
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `eliminar_iva`(IN id_iva1 INT,OUT msg TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Eliminar_Presentaciones`(in idPresentaciones1 int,out salida text)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Eliminar_Tipo`(IN id_tipo_f INT, OUT salida TEXT)
BEGIN
DECLARE esta_f CHAR(1);
    SET esta_f = 'I';
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Envase_Producto`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `estadoCliente`(
IN cedula123 TEXT, 
 OUT msg TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `estadoCliente2`(
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `faltantes_cantidad`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_actualizar_local`(IN nombre1 TEXT,IN direccion1 TEXT,IN telefono_pv1 TEXT, OUT salida TEXT)
BEGIN    
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_actualizar_usuario`(IN cedula1 TEXT, IN nombres1 TEXT, IN apellidos1 TEXT, IN telefono1 TEXT, IN convencional1 TEXT, IN correo1 TEXT, 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_combos_ac_usuarios`(IN op BIGINT,IN id BIGINT, OUT valor TEXT)
BEGIN
    SET valor=''; 
	IF op=1 THEN 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_combo_discapacidad`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_combo_genero`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_combo_porcentaje`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_combo_pv`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_combo_rol`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_crear_local`(IN nombre1 TEXT,IN direccion1 TEXT,IN telefono_pv1 TEXT, OUT salida TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_esatdo_usuario`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_estado_pv`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_filtro_apellido_usuario`(IN valor TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_filtro_cedula_usuario`(IN valor TEXT)
BEGIN
SELECT `fc_session`.`id_sesion`, `fc_usuario`.`fecha_registro`, `fc_usuario`.`cedula`, `fc_usuario`.`apellidos`, `fc_usuario`.`nombres`, 
	`fc_usuario`.`direccion`,`fc_usuario`.`telefono`, `fc_usuario`.`convencional`, `fc_usuario`.`correo`,`fc_genero`.`id_genero`, `fc_genero`.`genero`, 
	`fc_rol`.`id_rol`,`fc_rol`.`cargo`,`fc_estado_usuario`.`id_estado`,`fc_estado_usuario`.`estado`,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_filtro_cod_usuario`(IN valor BIGINT)
BEGIN
SELECT `fc_session`.`id_sesion`, `fc_usuario`.`fecha_registro`, `fc_usuario`.`cedula`, `fc_usuario`.`apellidos`, `fc_usuario`.`nombres`, 
	`fc_usuario`.`direccion`,`fc_usuario`.`telefono`, `fc_usuario`.`convencional`, `fc_usuario`.`correo`,`fc_genero`.`id_genero`, `fc_genero`.`genero`, 
	`fc_rol`.`id_rol`,`fc_rol`.`cargo`,`fc_estado_usuario`.`id_estado`,`fc_estado_usuario`.`estado`,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_filtro_estado_usuario`(IN valor BIGINT)
BEGIN
SELECT `fc_session`.`id_sesion`, `fc_usuario`.`fecha_registro`, `fc_usuario`.`cedula`, `fc_usuario`.`apellidos`, `fc_usuario`.`nombres`, 
	`fc_usuario`.`direccion`,`fc_usuario`.`telefono`, `fc_usuario`.`convencional`, `fc_usuario`.`correo`,`fc_genero`.`id_genero`, `fc_genero`.`genero`, 
	`fc_rol`.`id_rol`,`fc_rol`.`cargo`,`fc_estado_usuario`.`id_estado`,`fc_estado_usuario`.`estado`,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_filtro_fecha_usuario`(IN valor TEXT)
BEGIN
SELECT `fc_session`.`id_sesion`, `fc_usuario`.`fecha_registro`, `fc_usuario`.`cedula`, `fc_usuario`.`apellidos`, `fc_usuario`.`nombres`, 
	`fc_usuario`.`direccion`,`fc_usuario`.`telefono`, `fc_usuario`.`convencional`, `fc_usuario`.`correo`,`fc_genero`.`id_genero`, `fc_genero`.`genero`, 
	`fc_rol`.`id_rol`,`fc_rol`.`cargo`,`fc_estado_usuario`.`id_estado`,`fc_estado_usuario`.`estado`,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_filtro_pv_id`(IN id_punto_venta1 BIGINT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_filtro_pv_nombre`( IN nombre1 TEXT)
BEGIN
	SELECT `fc_punto_venta`.`id_punto_venta`,
	  `fc_punto_venta`.`nombre`,
	  `fc_punto_venta`.`direccion`,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_getComboVariosUsuario`(IN op BIGINT,IN id BIGINT, OUT valor TEXT)
BEGIN
	SET valor='';
	IF op=1 THEN 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_login_bitacora`(IN `user1` TEXT, IN `password1` TEXT, IN `ip_equipo1` TEXT, /*in `ip_publico1` text,*/
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_mostrar_local`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_mostrar_usuario`()
BEGIN
SELECT `fc_session`.`id_sesion`, `fc_usuario`.`fecha_registro`, `fc_usuario`.`cedula`, `fc_usuario`.`apellidos`, `fc_usuario`.`nombres`, 
`fc_usuario`.`direccion`,`fc_usuario`.`telefono`, `fc_usuario`.`convencional`, `fc_usuario`.`correo`,`fc_genero`.`id_genero`, `fc_genero`.`genero`, 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_nuevo_punto_venta`(IN localidad_guayas1 TEXT,IN nombre1 TEXT,IN direccion1 TEXT,IN ruc_local1 TEXT,IN telefono_pv1 TEXT,OUT salida TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_punto_venta_prueba`()
BEGIN
SELECT
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_registrar_usuario`(IN cedula1 TEXT, IN nombres1 TEXT, IN apellidos1 TEXT, IN telefono1 TEXT, IN convencional1 TEXT, IN correo1 TEXT, 
/*IN ip_publica1 TEXT,*//* IN genero1 TEXT, IN discapacidad1 TEXT, IN porcentaje_discapacidad1 TEXT, */
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_respaldo_usuario`(IN cedula1 TEXT,IN nombres1 TEXT,IN apellidos1 TEXT,IN telefono1 TEXT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `fc_ruc_local`(IN valor TEXT, OUT salida TEXT)
BEGIN
DECLARE v_id INT;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `filtroProducto`(IN consu TEXT)
BEGIN
	SET @query = CONCAT(consu);
    PREPARE statement FROM @query;       -- Preparar query.
    EXECUTE statement;                   -- Ejecutar query.
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `FiltroRangoFecha`(
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `FiltroRangoFecha2`(
IN op INT,IN Fecha1 DATETIME, IN Fecha2 DATETIME
)
BEGIN
IF op=1 THEN 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `FiltroRangoFecha3`(
IN op INT,IN Fecha1 DATETIME, IN Fecha2 DATETIME
)
BEGIN
IF op=1 THEN 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `FiltrosProductosNota`(IN Buscar_Producto TEXT,IN accion TEXT)
BEGIN
CASE accion
    WHEN 'TODO' THEN
    SELECT DISTINCT df.id_detalle_faltantes,pr.id_precio,df.id_producto,p.nombre AS producto,m.id_marcas,m.nombre AS marca
    ,p.id_presentacion,en.nombre AS presentaciones,p.id_medidas,me.nombre_medida AS medida
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `getComboPrecios`(IN op BIGINT, IN id BIGINT,OUT valor DOUBLE(5,2))
BEGIN
	SET valor='';
	IF op=1 THEN 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `getLocalidadComboGuayas`(IN op BIGINT,IN id BIGINT, OUT valor TEXT)
BEGIN
    SET valor='';
	IF op=1 THEN 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `getNombreComboProducto`(IN op BIGINT,IN id BIGINT, OUT valor TEXT,OUT valord DOUBLE)
BEGIN	
	SET valor='';
	IF op=1 THEN 
	...
	END IF;
    IF op=9 THEN 
	SELECT DISTINCT (c.`nombre`) INTO valor
	FROM `productos` p
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ingresarProducto`(IN codigo1 VARCHAR(30),IN nombre1 VARCHAR(45),IN descripcion1 VARCHAR(80),IN fecha_registro1 DATE,IN peso1 DOUBLE(7,2),IN id_tipo1 BIGINT(20), 
IN id_medidas1 BIGINT(20),IN id_envase1 BIGINT(20),IN id_marcas1 BIGINT(20),IN id_usuario1 BIGINT,IN iva1 VARCHAR(15),IN cantidad_minima1 BIGINT,IN receta1 VARCHAR(45),IN unidade1 BIGINT,IN id_categoria1 BIGINT(20), OUT valor1 TEXT)
BEGIN
	DECLARE nr INT; 
DECLARE id_pro INT; 
...
`id_medidas`,`id_presentacion`,`id_categoria`,`id_marcas`,`estado`,`id_usuario`,`iva`,`cantidad_minima`,`receta`,`unidades`) 
VALUES(codigo1,nombre1,descripcion1,fecha_registro1,peso1,id_tipo1,id_medidas1,id_envase1,id_categoria1,id_marcas1,'A',id_usuario1,iva1,cantidad_minima1,receta1,unidade1); 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ingresarProductoConvertidor`(IN nombre1 VARCHAR(45),IN descripcion1 VARCHAR(80),IN fecha_registro1 DATE,IN peso1 DOUBLE(7,2),IN id_tipo1 BIGINT(20),
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ingresoDePrecios`(IN op BIGINT, id_producto1 BIGINT,IN precio_compra2 DOUBLE(5,2),IN precio_venta3 DOUBLE(5,2),
...
/* Procedure structure for procedure `ingreso_pro_excel` */

/*!50003 DROP PROCEDURE IF EXISTS  `ingreso_pro_excel` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ingreso_pro_excel`(IN cod_barra1 VARCHAR(31),
						 IN nombre1 VARCHAR(46), 
						 IN descripcion1 VARCHAR(80), 						 
						 IN unidades1 BIGINT(20), 
						 IN peso1 DOUBLE(7,2), 
						 IN tipo1 VARCHAR(80), 
						 IN medida1 VARCHAR(80),
						 IN categoria1 VARCHAR(80), 
						 IN marca_laboratorio1 VARCHAR(80), 						  
						 IN presentacion1 VARCHAR(80),
						 IN cant_minima BIGINT(20), 
						 IN receta1 VARCHAR(20),
						 IN pre_base DOUBLE(5,2), 
						 IN pre_compra DOUBLE(5,2),
						 IN pre_venta DOUBLE(5,2),
						 IN desc_venta BIGINT(20), 
						 IN iva1 VARCHAR(15))
BEGIN
	DECLARE valor_id_productos INT;
	DECLARE valor_id_tipo INT;
	DECLARE valor_id_medida INT;
	DECLARE valor_id_categoria INT;
	DECLARE valor_id_marca INT;
	DECLARE valor_id_presentacion INT;
	DECLARE result TEXT;
	
		IF(nombre1 ='' OR peso1 = '' OR tipo1 ='' OR medida1 ='' OR categoria1 ='' OR marca_laboratorio1 ='' OR presentacion1='') THEN
			SET result ='Campos Invalidos. Ingrese campos faltantes';
		ELSE	
			SET valor_id_tipo =(SELECT id_nombre_tipo(tipo1));
			SET valor_id_medida = (SELECT `id_nombre_medida`(medida1));
			SET valor_id_categoria = (SELECT `id_nombre_categoria`(categoria1));
			SET valor_id_marca = (SELECT `id_nombre_marca`(marca_laboratorio1));
			SET valor_id_presentacion= (SELECT `id_nombre_presentacion`(presentacion1));
	
			INSERT INTO productos(nombre, descripcion, peso, id_tipo, id_medidas, id_categoria, id_marcas, estado, id_usuario, iva, cantidad_minima, receta, unidades, codigo_barras, id_presentacion)
				VALUES(nombre1, descripcion1, peso1, valor_id_tipo, valor_id_medida, valor_id_categoria, valor_id_marca, 'A', 1001, iva1, cant_minima, receta1, unidades1, cod_barra1, valor_id_presentacion);
				
			SET valor_id_productos = (SELECT id_productos FROM productos WHERE codigo_barras = cod_barra1 OR nombre = nombre1 AND descripcion = descripcion1);
			INSERT INTO precios(id_producto, precio_base, precio_compra, precio_venta, estado, id_usuario, descuentoVenta)
				VALUES(valor_id_productos, pre_base, pre_compra, pre_venta, 'A', 2, desc_venta);
			SET result = 'Guardado con exito';	
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `iniciar_sesion`(IN correo1 TEXT,IN password1 TEXT,IN ip_equipo1 TEXT, /*ip_publico1 text,*/ IN usuario_equipo1 TEXT, OUT salida TEXT)
BEGIN
DECLARE fecha_login1 DATETIME;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertaBitacoraFaltantes`(IN id_detalle_faltantes1 BIGINT(20), 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarCabceraCompras`(IN id_proveedor2 BIGINT,IN id_usuario3 BIGINT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarCabeceraNotaPedido`(IN id_proveedor1 BIGINT,IN id_usuario2 BIGINT,IN fecha_creacion3 DATETIME,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `InsertarCabeceraVentas`(
...
/* Procedure structure for procedure `insertarCategoriaProducto` */

/*!50003 DROP PROCEDURE IF EXISTS  `insertarCategoriaProducto` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarCategoriaProducto`(IN nombre1 VARCHAR(80), OUT valor1 TEXT)
BEGIN
	DECLARE nr INT;
	IF (nombre1='') THEN
	SET valor1 ='campos invalidos';
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarClientes`(
IN cedula TEXT,
IN nombre TEXT,
IN apellido TEXT,
IN direccion TEXT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarCorreo`( 
IN tipo_correo1 INT ,
IN correo TEXT,
IN cedula1 TEXT 
)
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarCorreoCliente`( 
IN cedula1 TEXT, 
IN correo TEXT,
OUT msg TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarDetalleCompras`(IN id_cabecera_compra1 BIGINT,IN id_precio2 BIGINT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `InsertarDetalleVentas`(
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarEnvaseProducto`(IN nombre1 VARCHAR(80), OUT valor1 TEXT)
BEGIN
	DECLARE nr INT;
	IF (nombre1='') THEN
	SET valor1 ='campos invalidos';
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarLab`(IN ruc1 TEXT, IN nombre1 TEXT, IN direccion1 TEXT, IN telefono1 TEXT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarMarcaProducto`(IN nombre1 VARCHAR(80), OUT valor1 TEXT)
BEGIN
	DECLARE nr INT;
	IF (nombre1='') THEN
	SET valor1 ='campos invalidos';
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarMedidaProducto`(IN nombre_medida1 VARCHAR(80), OUT valor1 TEXT)
BEGIN
	DECLARE nr INT;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarProveedor`(IN id_proveedor_clase1 BIGINT,IN cedula2 VARCHAR(15),
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarTelefono`(
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarTelefonoCliente`(
IN cedula1 TEXT,
IN id_Tipo_Telefono1 INT,
IN numero TEXT,
OUT msg TEXT)
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertarTipoProducto`(IN nombre1 VARCHAR(80), OUT valor1 TEXT)
BEGIN
	DECLARE nr INT;
	IF (nombre1='') THEN
	SET valor1 ='campos invalidos';
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Insertar_Categoria`(IN nombre_f TEXT, OUT salida TEXT)
BEGIN
	DECLARE nra INT;
    DECLARE esta_f CHAR(1);
	...
	SET nra = (SELECT validarCategoriaProducto(nombre_f));
	IF(nra<1) THEN 
	INSERT INTO categoria (`nombre`, `estado`) VALUES (nombre_f, esta_f);-- cambio realizado por cecj
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Insertar_Envase`(IN nombre_f TEXT, OUT salida TEXT)
BEGIN
	DECLARE nra INT;
    DECLARE esta_f CHAR(1);
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertar_fecha_caducidad`(IN fecha_cad DATE,IN cod_det BIGINT,OUT valor TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `insertar_iva`(IN iva1 DOUBLE, IN id_usuario1 INT, OUT msg TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Insertar_Kardex`(IN op BIGINT,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Insertar_Presentaciones`(
in nombre1 text,out salida text)
BEGIN
declare v int;
set v=(SELECT validarPresentacionesProducto(nombre1));
	if(v<1) then 
    insert into presentaciones(nombre,estado,fechaCreacion)VALUES (nombre1,'A',now());
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Insertar_Tipo`(IN nombre_f TEXT, OUT salida TEXT)
BEGIN
	DECLARE nra INT;
    DECLARE esta_f CHAR(1);
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `libreTransaccion`(IN consu TEXT)
BEGIN
    SET @query = CONCAT(consu);
    PREPARE statement FROM @query;       -- Preparar query.
    EXECUTE statement;                   -- Ejecutar query.
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listaComboLocalidadr`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarClientes`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ListarClientesVentas`(
IN op INT
)
BEGIN
    IF op=1 THEN 
...
/* Procedure structure for procedure `listarComboCategoriaPro` */

/*!50003 DROP PROCEDURE IF EXISTS  `listarComboCategoriaPro` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarComboCategoriaPro`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarComboEnvasePro`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarComboIva`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarComboMarcaPro`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarComboMedidaPro`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarComboPresentaciones`()
BEGIN
-- REVISADO --
SELECT idPresentaciones,nombre FROM presentaciones where estado='A' ORDER BY nombre;
END */$$
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarComboTipoPro`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarCorreo`(IN cedula1 TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarFaltantes`(IN op INT,IN id_cabecera_faltantes1 BIGINT)
BEGIN
IF op= 1 THEN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarfaltantesEnNota`(IN op INT)
BEGIN
IF op= 1 THEN
SELECT DISTINCT df.id_detalle_faltantes,pr.id_precio,df.id_producto,p.nombre AS producto,m.id_marcas,m.nombre AS marca
,p.id_presentacion,en.nombre AS presentaciones,p.id_medidas,me.nombre_medida AS medida
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarJoinProductos`(IN op INT)
BEGIN
IF op >0 THEN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarJoinProductosFaltantes`(IN op INT)
BEGIN
IF op >0 THEN
SELECT df.id_detalle_faltantes,df.fecha_registro,df.cantidad,df.estado,m.id_marcas,m.nombre AS MARCA,
p.id_productos,p.nombre,p.descripcion
...
JOIN detalle_faltantes  df ON df.id_producto=p.id_productos
JOIN marcas m ON m.id_marcas=p.id_marcas
WHERE df.estado = 'NO'AND p.estado='A';
ELSE
SELECT df.id_detalle_faltantes,df.fecha_registro,df.cantidad,df.estado,m.id_marcas,m.nombre AS MARCA,
p.id_productos,p.nombre,p.descripcion
FROM productos p
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarLaboratorio`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarPoductosCompras`(IN op INT)
BEGIN
    IF op=1 THEN
...
p.`id_presentacion`,e.`nombre`AS PRESENTACION ,p.`id_marcas`,ma.`nombre` AS marca,p.`id_categoria`,ca.`nombre` AS categoria, p.id_usuario, p.iva , p.cantidad_minima,p.`receta`,p.`unidades`
      FROM `productos` p
      JOIN `tipo` t ON t.`id_tipo`= p.`id_tipo` 
      JOIN `medidas` m ON m.`id_medidas`= p.`id_medidas`
      JOIN `presentaciones` e ON e.`idPresentaciones`= p.`id_presentacion`
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ListarPrecioNotaPedido`(IN op INT,IN id_producto1 BIGINT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarProductosStock`(IN op BIGINT)
BEGIN
    IF(op=1)THEN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ListarProductosVentas`(
IN op INT
)
BEGIN
    IF op=1 THEN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ListarProveedor`(IN op BIGINT)
BEGIN
IF (op=1)THEN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarPuntoVenta`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ListarRegistroDeNotas`(IN op INT)
BEGIN
IF op=1 THEN
SELECT cnp.`id_cabecera_nota_pedidos`,cnp.`id_proveedor`,p.`entidad` AS proveedor,p.`correo`,p.`id_proveedor_clase`,pc.`clase`,
p.`direccion`,p.`cedula_ruc`,p.`representante`,p.`telefono`,cnp.`fecha_creacion`,cnp.`estado`,cnp.`iva`,cnp.`descuento`,cnp.`total`
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ListarRegistroDetalleNotaPedido`(IN op INT,IN id TEXT)
BEGIN
  IF op=1 THEN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ListarRegistroDetalleVenta`(
IN idCab BIGINT
)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `ListarRegistroVenta`(
IN op INT
)
BEGIN
	IF op=1 THEN 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `listarTelefono`(IN cedula1 TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `llamarIVAactual`(OUT valor TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `modificarProductos`(IN nombre1 VARCHAR(45),IN descripcion1 VARCHAR(80),IN peso1 DOUBLE(7,2),
    ...
    IN id_usuario1 BIGINT, IN iva1 VARCHAR(5), IN cantidad_minima1 BIGINT,IN receta1 TEXT,IN unidade1 BIGINT, IN categoria1 BIGINT(20), OUT valor TEXT)
BEGIN
    IF (nombre1='' OR descripcion1='' OR peso1='' OR id_tipo1='' OR id_medidas1='' OR id_envase1='' OR id_marcas1=''
    OR id_usuario1='' OR iva1='' OR cantidad_minima1='' OR  categoria1='' )THEN
    SET valor = 'campos invalidos';
    ELSE 
	UPDATE productos SET nombre = nombre1,descripcion = descripcion1,peso=peso1 ,id_tipo= id_tipo1,
	`id_medidas`= id_medidas1,`id_presentacion`=id_envase1,`id_categoria`=categoria1,`id_marcas`=id_marcas1,`id_usuario`=id_usuario1,
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `mostrar_iva`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `mostrar_usuario`()
BEGIN
SELECT `fc_session`.`id_sesion`, `fc_usuario`.`fecha_registro`, `fc_usuario`.`cedula`, `fc_usuario`.`apellidos`, `fc_usuario`.`nombres`, 
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `nuevo_punto_venta`(nombre_localidad1 TEXT,nombre_local1 TEXT,  direccion1 TEXT,dir_ip1 TEXT, OUT salida TEXT)
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `registrar_usuario`()
BEGIN
    END */$$
DELIMITER ;
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `Tipo_Producto`()
BEGIN
...
/*!50003 CREATE DEFINER=`asofar`@`%` PROCEDURE `universal_sentences`(IN consu TEXT)
BEGIN
    SET @query = CONCAT(consu);
    PREPARE statement FROM @query;       -- Preparar query.
    EXECUTE statement;                   -- Ejecutar query.
