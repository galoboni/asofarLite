...
insert  into `categoria`(`id_categoria`,`nombre`,`estado`,`usuario_creacion`,`fecha_creacion`,`usuario_actualizacion`,`fecha_actualizacion`) values (1,'ALIMENTOS','A',NULL,'2019-11-01 14:01:22',NULL,'2019-11-01 14:13:11'),(2,'BEBIDAS','A',NULL,'2019-11-01 14:01:52',NULL,'2019-11-01 14:13:34'),(3,'MEDICINAS','A',NULL,'2019-11-01 14:02:24',NULL,'2019-11-01 14:02:24'),(4,'UTENSILIOS PARA BEBES ','A','admin','2020-02-08 22:35:55',NULL,NULL),(5,'COSMETICOS','A','admin','2020-02-11 16:02:13',NULL,NULL),(6,'BOTELLONES','A',NULL,NULL,NULL,NULL),(7,'VERDURAS','A',NULL,NULL,'admin','2020-09-12 23:52:50'),(8,'HOGAR','A','admin','2020-09-13 00:17:25','admin','2020-09-13 00:43:39');
...
insert  into `detalle_faltantes`(`id_detalle_faltantes`,`id_producto`,`id_usuario`,`fecha_registro`,`cantidad`,`estado`) values (2,21,NULL,'2019-03-22 16:12:33',112,'TR'),(3,22,NULL,'2019-03-21 16:52:41',207,'OK'),(4,23,NULL,'2019-03-21 18:07:56',320,'TR'),(5,25,NULL,'2018-12-13 16:29:18',500,'OK'),(6,24,NULL,'2018-12-13 16:29:18',400,'OK'),(10,27,NULL,'2019-03-21 16:52:41',594,'OK'),(11,32,NULL,'2019-03-21 16:52:41',60,'TR'),(12,31,2,'2019-03-19 17:47:07',100,'TR'),(13,33,2,'2019-03-19 17:47:07',55,'OK'),(14,34,NULL,'2019-02-25 00:00:00',13,'NO'),(15,35,NULL,'2019-02-25 00:00:00',0,'NO'),(16,36,NULL,'2019-03-21 00:00:00',0,'NO'),(17,37,NULL,'2019-03-22 16:13:06',34,'TR'),(18,38,NULL,'2019-03-22 17:23:34',0,'OK'),(19,39,NULL,'2019-03-29 00:00:00',0,'NO'),(20,40,NULL,'2019-03-29 00:00:00',0,'NO'),(21,41,NULL,'2019-03-29 18:56:33',5,'OK'),(22,42,NULL,'2019-04-11 00:00:00',0,'NO'),(23,43,NULL,'2019-04-15 00:00:00',0,'NO'),(24,45,NULL,'2020-09-13 00:00:00',0,'NO');
...
insert  into `kardex`(`idkardex`,`id_producto`,`id_cabecera_compra`,`id_detalle_compra`,`id_cabecera_venta`,`id_detalle_venta`,`id_precio`,`cantidad`,`total`,`fecha_generada`) values (3,38,21,11,NULL,NULL,52,10,10.50,'2020-09-12 20:17:14'),(4,38,21,11,NULL,NULL,52,15,10.50,'2020-09-12 20:24:30'),(5,38,21,11,NULL,NULL,52,5,20.00,'2020-09-13 13:17:55');
...
insert  into `marcas`(`id_marcas`,`nombre`,`estado`) values (1,'bayer','A'),(2,'pelikan','A'),(3,'bago','A'),(4,'Avon','A');
...
insert  into `medidas`(`id_medidas`,`nombre_medida`,`estado`) values (1,'ml','A'),(2,'lt','A'),(3,'mml','A'),(4,'15 LT','A'),(5,'56 GR','A'),(6,'GR','A'),(7,'PRUEBA1','A'),(8,'PRUEBA2','A'),(9,'PRUEBA3','A'),(10,'PRUEBA4','A'),(11,'PRUEBA5','A'),(12,'100 LT','A'),(13,'6-10 KG','A'),(14,'150ml','A'),(15,'15ml/16g','A');
...
insert  into `presentaciones`(`idPresentaciones`,`nombre`,`estado`,`usuarioCreacion`,`fechaCreacion`) values (1,'frasco','A','admin','2019-11-01 13:21:53'),(2,'Tubo','A',NULL,NULL),(3,'Botella','A','admin','2020-09-13 01:13:40');
...
insert  into `productos`(`id_productos`,`nombre`,`descripcion`,`fecha_registro`,`peso`,`id_tipo`,`id_medidas`,`id_categoria`,`id_marcas`,`estado`,`id_usuario`,`iva`,`cantidad_minima`,`receta`,`unidades`,`codigo_barras`,`id_presentacion`) values (21,'ASPIRINA','dolores de cabeza','2018-11-16',15.50,5,4,2,1,'A',1,'NO',15,NULL,NULL,NULL,1),(22,'AMOXICILINA','INFECCION','2018-11-16',10.20,5,5,2,2,'A',2,'NO',24,NULL,NULL,NULL,1),(23,'PASTA','MEBOCAINA','2018-11-21',1.26,6,1,1,1,'A',3,'SI',14,NULL,NULL,NULL,1),(24,'IBUPROFENO ','DOLORES DE CABEZA,ESTOMAGO,FIEBRE','2018-11-22',0.50,11,5,2,1,'A',7,'NO',7,NULL,NULL,NULL,1),(25,'LEMONFLU2','RESFRIADOS ','2018-11-30',10.00,7,5,2,1,'A',2,'NO',29,NULL,NULL,NULL,1),(27,'tucol','jarabe para la toz','2018-12-12',15.60,2,3,1,1,'A',3,'NO',14,NULL,NULL,NULL,1),(28,'GAMALATE','CONCENTRACION','2018-12-13',2.60,7,1,2,1,'A',2,'0.12',15,NULL,NULL,NULL,1),(29,'ZALEPLA','RELAJACION','2018-12-13',2.60,11,1,1,1,'A',3,'NO',14,NULL,NULL,NULL,1),(30,'AFRIN','PARA DESCONGESTIONAR LA NARIZ','2018-12-18',2.36,7,3,1,1,'A',5,'NO',19,NULL,NULL,NULL,1),(31,'VITAMINA C','VITAMINAS','2018-12-20',0.63,5,2,3,1,'A',2,'0.12',15,NULL,NULL,NULL,1),(32,'OMEPRASOL','INFECCIONES','2018-12-21',2.30,5,6,2,2,'A',2,'0.12',45,NULL,NULL,NULL,1),(33,'TRIPLE ACCION','PASTA DENTAL','2019-01-20',1.05,10,4,2,1,'A',2,'0.12',10,NULL,NULL,NULL,1),(34,'ALCOHOL','LIMPIEZA CORPORAL','2019-02-25',12.00,7,3,2,1,'A',2,'',23,NULL,NULL,NULL,1),(35,'TERMOMETRO','FIEBRE','2019-02-25',0.23,5,4,1,1,'A',2,'0.12',34,NULL,NULL,NULL,1),(36,'PARACETAMOL2','PRUEBA2','2019-03-21',34.00,6,5,2,3,'A',36,'NO',35,NULL,NULL,NULL,1),(37,'PASTA','DENTAL','2019-03-21',0.80,10,6,2,2,'A',53,'0.12',15,NULL,NULL,NULL,1),(38,'APRONAX','NAPROXENO SODICO 500MG','2019-03-22',550.00,6,6,2,1,'I',53,'NO',1,NULL,NULL,NULL,1),(39,'SDCWD','SDCSD','2019-03-29',10.00,5,6,2,3,'A',53,'NO',23,'SIN RECETA ',NULL,NULL,1),(40,'AMOXICILINA1','INFECCION1','2019-03-29',10.20,5,5,4,2,'A',3,'NO',24,NULL,NULL,NULL,1),(41,'LACTIBON LOCION 3.5 PH','SUSTITUTO DE JABON','2019-03-29',8.00,7,1,1,1,'A',53,'0.12',3,'SIN RECETA ',NULL,NULL,1),(42,'ACERLET','ACERLET 500','2019-04-11',3.00,7,6,2,3,'A',53,'NO',23,'SIN RECETA ',24,NULL,1),(43,'PAÑALIN','EXTRA GRANDES','2019-04-15',10.00,12,13,2,2,'A',53,'NO',3,'SIN RECETA ',24,'7702111376564',1),(44,'COLA BLANCA ','GOMA','2020-09-09',15.00,16,15,7,4,'A',1001,'12',1,'NO APLICA',1,'2000013895288',1),(45,'VASO','PARA HOGAR','2020-09-13',5.00,5,4,2,1,'A',1,'NO',1,'SIN RECETA',10,'000123',1);
...
insert  into `productos_app`(`id_productos`,`nombre`,`descripcion`,`fecha_registro`,`peso`,`id_tipo`,`id_medidas`,`id_categoria`,`id_marcas`,`estado`,`id_usuario`,`iva`,`cantidad_minima`,`receta`,`unidades`,`codigo_barras`,`registro_actualizado`,`precio_producto_app`,`id_presentacion`) values (3,'BLACK SUEDE','SPRITE BLACK SUEDE','2020-09-09 23:26:32',12.00,2,1,5,1,'A',1001,'12',1,'NO APLICA',1,'7909189114641','S','12',1),(4,'COLA BLANCA ','GOMA','2020-09-09 23:53:45',15.00,16,15,7,4,'A',1001,'12',1,'NO APLICA',1,'2000013895288','S','15',2);
...
insert  into `tipo`(`id_tipo`,`nombre`,`estado`) values (2,'jarabe para la toz','A'),(4,'pastilla para dolores de cabez','A'),(5,'Antibiótico','A'),(6,'analgesico','A'),(7,'Antialérgicos','A'),(8,'AntiInflamatorios ','A'),(9,'PELOTAS','A'),(10,'VIVERES','A'),(11,'ANTIPIRÉTICOS','A'),(12,'ANTIIRRITACIONES','A'),(13,'varios','A'),(14,'medicina','A'),(15,'medicina','A'),(16,'liquido','A'),(17,'asf','A');
...
in nombre1 text,in id_categoria1 int,IN usuario1 VARCHAR(15) ,out salida text)
BEGIN
declare v int;
set v=(SELECT validarCategoriaProducto(nombre1));
	if(v<1) then 
	update categoria
    set nombre=nombre1 , fecha_actualizacion=now() , usuario_actualizacion=usuario1
...
set v=(SELECT validarCategoriaProducto(nombre1));
	if(v<1) then 
    insert into categoria (nombre,estado,usuario_creacion,fecha_creacion)VALUES (nombre1,'A',usuario1,now());
