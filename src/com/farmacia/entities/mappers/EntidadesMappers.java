...
//            obj.setPrecios(rs.getBigDecimal("PRECIO"));
    ...
    public static PresentacionProducto getPresentacionProductoFromResultSet(ResultSet rs) {
        PresentacionProducto obj = new PresentacionProducto();
        try {
            obj.setId_presentaciones(rs.getLong("IDPRESENTACIONES"));
            obj.setNombrePresentacion(rs.getString("NOMBRE"));
