 ...
 * @author michaels
 */
public final class Presentacion_Actualizado extends javax.swing.JDialog {
    int x,y;
    CRUD crud = new CRUD();
    Presentaciones tipo = new Presentaciones(new javax.swing.JFrame(), true);
    static PresentacionProducto tp2 = null;

    public Presentacion_Actualizado(java.awt.Frame parent, boolean modal, PresentacionProducto tp1) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public void llenarDatos(PresentacionProducto to) {
        actualizar_tf.setText(to.getNombrePresentacion());
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               Presentacion_Actualizado dialog = new Presentacion_Actualizado(new javax.swing.JFrame(), true, tp2);
