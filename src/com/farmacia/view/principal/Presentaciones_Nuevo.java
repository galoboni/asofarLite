...
public class Presentaciones_Nuevo extends javax.swing.JDialog {
    ...
    public Presentaciones_Nuevo(java.awt.Frame parent, boolean modal,Listar_usuario objUsuario) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
        this.usuario=objUsuario.getCargo();
        //id_usuario=objUsuario.getId_sesion().toString(); //obj.getId_sesion().toString()
    ...
    private void initComponents() {
        ...
        jLabel2.setText("NUEVA PRESENTACIÓN");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Presentaciones_Nuevo dialog = new Presentaciones_Nuevo(new javax.swing.JFrame(), true);
