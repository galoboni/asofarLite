 ...
 * @author michaels
 */
public class Presentaciones extends javax.swing.JDialog {
    int x,y;
    CRUD crud = new CRUD();
    PresentacionProducto tp = new PresentacionProducto();
    ArrayList<PresentacionProducto> altp = null;
     ...
     * @param modal
     */
    public Presentaciones(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public Presentaciones(java.awt.Frame parent, boolean modal,Listar_usuario objUsuario) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        setLocationRelativeTo(null);
    ...
    private void envase_tbMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_envase_tbMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (tp != null) {
                setVisible(false);
                Presentacion_Actualizado ta = new Presentacion_Actualizado(new javax.swing.JFrame(), true, tp);
                ta.setVisible(true);
            }
        }
    ...
    public PresentacionProducto devuelveObjeto(int id, ArrayList<PresentacionProducto> lista) {
        PresentacionProducto gh = new PresentacionProducto();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Presentaciones dialog = new Presentaciones(new javax.swing.JFrame(), true);
