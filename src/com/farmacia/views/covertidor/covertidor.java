...
public class covertidor extends javax.swing.JDialog {
    ...
    ArrayList<PresentacionProducto> listae = null;
    ArrayList<MarcaProducto> listama = null;
    String str_tipo = null, str_medidas = null, str_presentacion = null, str_marcas = null, strIva = null;
    String error = "", IVA = "";
    Long id_tipo, id_medida, id_presentacion, id_marca, id_PrecioNuevo;
    ...
    public void listarCombos(listarJoinProductosCompras obj) {
        ...
        cbxEnvase1.setSelectedItem(str_presentacion);
...
//        }
        ...
        if (pos < 0) {
            ...
            id_presentacion = listae.get(pos).getId_presentaciones();
    ...
    private void cbxElaineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxElaineActionPerformed
     ...
     public void listarCombosJpanel4(listarJoinProductosCompras obj) {
        ...
        str_presentacion = crud.getNombreComboProducto(Long.valueOf("3"), obj.getId_Presentacion());
        cbxEnvase4.setSelectedItem(str_presentacion);
        str_marcas = crud.getNombreComboProducto(Long.valueOf("4"), obj.getId_marca());
...
//        listama = crud.listarTodoMarcaProductos();
        ...
        str_presentacion = crud.getNombreComboProducto(Long.valueOf("3"), objeto.getId_Presentacion());
        cbxEnvase3.setSelectedItem(str_presentacion);
