...
//    }
    ...
    public static void listarPresentacion(ArrayList<PresentacionProducto> lista, JTable Tabla) {
        int[] a = {10, 30, 32, 52,};
        DefaultTableCellRenderer tcr = new DefaultTableCellRenderer();
        DefaultTableCellRenderer tcr1 = new DefaultTableCellRenderer();
        tcr.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            Filas[1] = lista.get(i).getNombrePresentacion();
            model.addRow(Filas);
            Tabla.setModel(model);
            Tabla.getColumnModel().getColumn(0).setPreferredWidth(a[0]);
            Tabla.getColumnModel().getColumn(0).setCellRenderer(tcr);
...
//cargarJoinProductoIngresoNotas
    ...
    public static void cargarJoinProductoIngresoNotas(JTable Tabla, ArrayList<joinProductoDetallesFaltantes> lista) {
        ...
        tcr1.setHorizontalAlignment(SwingConstants.RIGHT);
        model = Tablas.VaciarTabla(Tabla);
        String[] Co = {"CODIGO", "MARCA", "TIPO", "PRODUCTO", "PRESENTACION", "MEDIDA", "BONO", "CANTIDAD", "PRECIO", "DESCUENTO", "IVA", "TOTAL"};
...
//            Tabla.getColumnModel().getColumn(4).setCellRenderer(tcr);
    ...
    public static void ListarConvertidorProductos(ArrayList<listarJoinProductosCompras> lista, JTable Tabla) {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            Filas[7] = lista.get(i).getNombrePresentacion();
